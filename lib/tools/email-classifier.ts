...
- estado_cuenta_proveedor: el proveedor envía su "estado de cuenta" / relación de facturas que dice tener pendientes de pago (adjunto en Excel, PDF, o una imagen del estado de cuenta en el cuerpo del correo). Se distingue de solicitud_pago en que aquí el proveedor afirma un LISTADO de facturas pendientes (no pide el detalle de UN pago ya hecho) y normalmente trae o menciona un adjunto con el desglose.
