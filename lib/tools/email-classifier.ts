...
- estado_cuenta_proveedor: el proveedor envía su "estado de cuenta" / relación de facturas que dice tener pendientes de pago (adjunto en Excel, PDF, o una imagen del estado de cuenta en el cuerpo del correo). Se distingue de solicitud_pago en que aquí el proveedor afirma un LISTADO de facturas pendientes (no pide el detalle de UN pago ya hecho) y normalmente trae o menciona un adjunto con el desglose. También aplica cuando el proveedor adjunta una o varias facturas (no necesariamente un "estado de cuenta" formal) y pide conocer el ESTATUS DE PAGO de esas facturas, sobre todo si menciona que algunas ya están vencidas (ej. "Requerimos de su colaboración para saber el estatus de pago de las facturas adjuntas, cabe mencionar que varias ya se encuentran vencidas"). También aplica cuando el proveedor dice que NO recibió un pago esperado y pide que se le confirme la nueva fecha de pago (ej. "No recibimos el pago, por favor su apoyo confirmando la nueva fecha de pago"), sin importar si mencionan o no números de factura específicos — en general, cualquier correo de un proveedor preguntando por el estatus, fecha o confirmación de pago de sus facturas cae aquí.
